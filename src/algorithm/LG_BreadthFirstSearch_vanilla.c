...
//    semiring = GxB_PLUS_TIMES_FP64;
    ...
    GrB_Index last_nq = 0 ;
    GrB_Index current_level = 1; /// Changed by Zhen Peng on 02/09/2023, because l_level is dense now
//    GrB_Index current_level = 0;
    ...
    /// Turn off the sorting by Zhen Peng on 02/09/2023
