...
module purge
module load llvm/13.0.0 python/3.7.0 binutils/2.35
...
project_path="/people/peng599/pppp/clion/LAGraph_mac/local_stuff/bfs"
command="bash scripts/test3.LLVM_matrices_bfs.sh"
